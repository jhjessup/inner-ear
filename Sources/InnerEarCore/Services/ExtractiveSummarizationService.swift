...
public final class ExtractiveSummarizationService: SummarizationService, @unchecked Sendable {
    ...
    private static let stopwords: Set<String> = [
        ...
        "with", "this", "that", "it", "i", "you", "we", "they",
        "he", "she", "be", "have", "has", "had", "do", "does",
        "did", "not", "so", "if", "as", "by", "from", "will",
        "would", "can", "could", "um", "uh", "my", "your", "our",
        "their", "his", "her", "its", "me", "him", "us", "them",
        "am", "been", "being", "shall", "should", "may", "might", "must",
        "ought", "need", "dare", "used", "use", "using", "also", "just",
        "like", "well", "then", "than", "very", "much", "many", "more",
        "most", "some", "any", "all", "each", "every", "other", "another",
        "such", "only", "own", "same", "too", "even", "still", "yet",
        "already", "ever", "never", "now", "here", "there", "when", "where",
        "why", "how", "what", "which", "who", "whom", "whose", "these",
        "those", "up", "down", "out", "off", "over", "under", "again",
        "further", "once", "twice", "first", "second", "last", "next", "previous",
        "new", "old", "good", "bad", "big", "small", "long", "short",
        "high", "low", "early", "late", "right", "wrong", "true", "false",
        "yes", "no", "maybe", "okay", "ok", "sure", "thanks", "thank",
        "please", "sorry", "excuse", "pardon", "hello", "hi", "bye", "goodbye",
        "see", "look", "listen", "hear", "watch", "wait", "go", "come",
        "get", "give", "take", "make", "let", "put", "set", "keep",
        "hold", "bring", "send", "show", "tell", "ask", "answer", "say",
        "speak", "talk", "think", "know", "understand", "mean", "want", "love",
        "hate", "hope", "wish", "expect", "seem", "appear", "sound", "feel",
        "taste", "smell"
    ]
